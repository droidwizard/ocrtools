...
public class Consts {
	...
	// địa điểm
	public static final String PLACE = "([ĐịaTạ]+[ điểmễ:]+)(.+)";
	// tìm email
	public static final String EMAIL = "[a-zA-Z][\\w]+@[\\w]+.[\\w]+(.[\\w]*)[ ]*";
	// tìm số dt dạng
	public static final String MOBILE = "0[19][\\d]+[. \\-,\\d]+[\\d]+";
	// tìm tên
	...
	private static final String RARENAME_UPPER1 = " AN | ÁNH| ÂN | ẤU |BÁ | BÁ |BẠC| BẠC|BẠCH| BẠCH|BÀNG| BÀNG|BÀNH| BÀNH|BẢO| BẢO|BỬU| BỬU|BẾ | BẾ |BÌ | BÌ |BIỆN | BIỆN |BỒ | BỒ |CA | CA |CÁI| CÁI|CAM| CAM|CÁT| CÁT|CẦM| CẦM|CẤN| CẤN|CHẾ | CHẾ |CHIÊM| CHIÊM|CHU | CHU |CHÂU| CHÂU|CHUNG| CHUNG|CHƯƠNG| CHƯƠNG|CHỬ | CHỬ |CỔ | CỔ |CÙ | CÙ |CUNG| CUNG|CỰ | CỰ |DÃ | DÃ |DANH| DANH|DOÃN| DOÃN|DƯ | DƯ ";
	private static final String RARENAME_UPPER2 = "ĐÀM| ĐÀM|ĐAN | ĐAN |ĐÀO| ĐÀO|ĐẬU| ĐẬU|ĐIỀN| ĐIỀN|ĐINH| ĐINH|ĐOÀN | ĐOÀN |ĐÔN | ĐÔN |ĐỒNG| ĐỒNG|ĐỔNG| ĐỔNG|ĐỚI| ĐỚI|ĐÁI| ĐÁI|ĐƯỜNG| ĐƯỜNG|GIẢ | GIẢ |GIAO| GIAO|GIANG| GIANG|GIÁP| GIÁP|HÀ | HÀ |HẠ | HẠ |HÀN | HÀN |HÁN | HÁN |HY | HY |HÌNH| HÌNH| HOA|HỒNG| HỒNG|HÙNG| HÙNG|HỨA| HỨA|KHA | KHA |KHƯƠNG| KHƯƠNG|KHÂU| KHÂU|KHƯU| KHƯU|KHỔNG| KHỔNG|KHU | KHU |KHUẤT| KHUẤT|KHÚC| KHÚC|KIỀU| KIỀU|KIM| KIM|LA | LA ";
	private static final String RARENAME_UPPER3 = "LẠC| LẠC|LẠI| LẠI|LỀU| LỀU|LIỄU| LIỄU|LÒ | LÒ |LỤC| LỤC|LƯ | LƯ |LÔ | LÔ |LỮ | LỮ |LÃ | LÃ |LƯƠNG| LƯƠNG|LƯU| LƯU|MA | MA |MÃ | MÃ |MẠC | MẠC |MẠCH| MẠCH|MAI| MAI|MANG| MANG|MẪN | MẪN |MỘC| MỘC|NINH| NINH|NHÂM| NHÂM|NHẬM| NHẬM|NHIỆM| NHIỆM|NGHIÊM| NGHIÊM|NGỤY| NGỤY|NHỮ | NHỮ |NÔNG| NÔNG| ÔNG| ÔNG |PHI | PHI |PHÍ | PHÍ |PHÓ | PHÓ |PHÙNG| PHÙNG|PHƯƠNG| PHƯƠNG|QUẢN | QUẢN |QUÁCH| QUÁCH|SƠN| SƠN |TẠ | TẠ |TÀO| TÀO";
	private static final String RARENAME_UPPER4 = "TĂNG| TĂNG|THẠCH| THẠCH|THÁI| THÁI|THÀO| THÀO|THÂN | THÂN |THẬP| THẬP|THI | THI |THIỀU| THIỀU|THỊNH| THỊNH|THÔI| THÔI|TIÊU| TIÊU|TÒNG| TÒNG|TÔ |TÔN | TÔN |TÔNG| TÔNG|TỐNG| TỐNG|TRÀ | TRÀ |TRÁC | TRÁC |TRIỆU| TRIỆU|TRỊNH| TRỊNH|TRÌNH| TRÌNH|TRƯNG| TRƯNG|TRƯƠNG| TRƯƠNG|TỪ | TỪ | UÔNG| UÔNG | UNG| UNG |VI | VI |VIÊN | VIÊN |VƯƠNG| VƯƠNG|XA | XA | YÊN ";

	public static final String POS_NAME = "(GSTS|PSGTS|TS|Ths|CH|TSKH|CN|Dược|Bác Sĩ|BS|Kỹ|Ms|Mr|Miss).+";
