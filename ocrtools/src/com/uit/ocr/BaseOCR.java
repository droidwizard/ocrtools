...
public class BaseOCR extends Activity {
	...
	private static final String RARENAME_LOWER1 = "( An|An)|( Ánh|Ánh)|( Ân|Ân)|( Âu|Âu)|( Ấu|Ấu)|( Bá|Bá)|( Bạc|Bạc)|( Bạch|Bạch)|( Bàng|Bàng)|( Bành|Bành)|( Bảo|Bảo)|( Bửu|Bửu)|( Bế|Bế)|( Bì|Bì)|( Biện|Biện)|( Bồ|Bồ)|( Ca|Ca)|( Cái|Cái)|( Cam|Cam)|( Cao|Cao)|( Cát|Cát)|( Cầm|Cầm)|Cấn|Chế|Chiêm|Chu|Châu|Chung|Chương|Chử|Cổ|Cù|Cung|Cự|Dã|Danh|Doãn|Dư";
	...
	private static final String RARENAME_LOWER3 = "Lạc|Lại|Lâm|Lều|Liễu|Lò|Lục|Lư|Lô|Lữ|Lã|Lương|Lưu|Ma|Mã|Mạc|Mạch|Mai|Mang|Mẫn|Mộc|Ninh|Nhâm|Nhậm|Nhiệm|Nghiêm|Ngụy|Nhữ|Nông|( Ông|Ông)|Phi|Phí|Phó|Phùng|Phương|Quản|Quách|Sơn|Tạ|Tào";
	private static final String RARENAME_LOWER4 = "Tăng|Thạch|Thái|Thào|Thân|Thập|Thi|Thiều|Thịnh|Thôi|Tiêu|Tòng|Tô|Tôn|Tông|Tống|Trà|Trác|Triệu|Trịnh|Trình|Trưng|Trương|Từ|Uông|Ung|Văn|Vi|Viên|Vương|Xa|\\nYên";

	private static final String RARENAME_UPPER1 = "AN|ÁNH|ÂN|\\nÂU|ẤU|BÁ|BẠC|BẠCH|BÀNG|BÀNH|BẢO|BỬU|BẾ|BÌ|BIỆN|BỒ|CA|CÁI|CAM|CAO|CÁT|CẦM|CẤN|CHẾ|CHIÊM|CHU|CHÂU|CHUNG|CHƯƠNG|CHỬ|CỔ|CÙ|CUNG|CỰ|DÃ|DANH|DOÃN|DƯ";
